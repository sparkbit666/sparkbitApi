...
Welcome to [sparkbit](https://www.sparkbit.io/index) API document for developers.
...
Before signing any request, you must generate an API key via [Exchange’s official website ](https://www.sparkbit.io/index)【User Center】-【API】. After generating the key, there are three things you must bear in mind:
...
The root URL for REST access：``` https://openapi.sparkbit.io ```
...
public class WsTest {
    ...
    public static void main(String[] args) {
        try {
//wsurl 
            String url = "wss://ws.sparkbit.io/kline-api/ws";
...
//Thread does not end, waiting for new messages，www.sparkbit.io Generally, a new deal will return in about a minute
            while (true) {
                Thread.sleep(1000);
            }
